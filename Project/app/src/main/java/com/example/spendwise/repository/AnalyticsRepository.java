...
public class AnalyticsRepository {
    ...
    /**
     * Builds a category -> total amount map for the provided expense list constrained
     * to the supplied time window.
     */
    ...
    /**
     * Produces per-budget usage summaries constrained to the supplied time window.
     * Only budgets with matching expenses in the range are returned.
     */
    ...
    /**
     * Generates placeholder summaries for chart rendering when datasets are empty.
     */
    ...
    /**
     * Generates placeholder category totals for empty datasets.
     */
